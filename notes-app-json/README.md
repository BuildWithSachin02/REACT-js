...
* 🎲 Automatically assign a random background color if none is selected
* 🖼️ Add images using image URLs
* 📅 Display the note creation date
* 🕒 Display the note creation time
* 🗑️ Delete notes
...
If you found this project helpful, consider giving it a ⭐ on GitHub. Your support helps motivate future improvements and open-source contributions.
